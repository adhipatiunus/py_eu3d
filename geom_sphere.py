...
x_bound_ = np.concatenate((x_east_,x_north_,x_west_,x_south_,x_top_,x_bottom_,x_sphere_))
y_bound_ = np.concatenate((y_east_,y_north_,y_west_,y_south_,y_top_,y_bottom_,y_sphere_))
z_bound_ = np.concatenate((z_east_,z_north_,z_west_,z_south_,z_top_,z_bottom_,z_sphere_))
normal_x_bound_ = np.concatenate((normal_x_east_,normal_x_north_,normal_x_west_,normal_x_south_,normal_x_top_,normal_x_bottom_,normal_x_sphere_))
normal_y_bound_ = np.concatenate((normal_y_east_,normal_y_north_,normal_y_west_,normal_y_south_,normal_y_top_,normal_y_bottom_,normal_y_sphere_))
normal_z_bound_ = np.concatenate((normal_z_east_,normal_z_north_,normal_z_west_,normal_z_south_,normal_z_top_,normal_z_bottom_,normal_z_sphere_))
...
h_bound_ = np.concatenate( (hmax*np.ones(n_bounding_box), hmin*np.ones(n_sphere)) ) 
...
ax.add_artist(Circle((X0, Z0), RAD, color='k'))
ax.set_aspect('equal')
...
geom = {'h':h, 'n_total':n_total, 'n_bound':n_bound,\
    'n_east':n_east,'n_north':n_north,'n_west':n_west,'n_south':n_south,\
        'n_top':n_top,'n_bottom':n_bottom,'n_sphere':n_sphere,'RAD':RAD,\
